...
class StatistikIbuHamilPetugas extends StatefulWidget {
  ...
  State<StatistikIbuHamilPetugas> createState() =>
      _StatistikIbuHamilPetugasState();
}

class _StatistikIbuHamilPetugasState extends State<StatistikIbuHamilPetugas> {
  ...
  void initState() {
    ...
    // print("petugas : ${widget.petugasWithIbuHamilModel}");
  }
